...
const Faq = () => {
  ...
  return (
    <div className='w-full h-full'>
        <Navbar/>
        <div className='w-full h-full'>
            <h1 className='text-4xl font-bold text-center my-10'>Frequently Asked Questions</h1>
            ...
            <div key={faqmap.id} className="w-5/6  mx-auto py-4 my-4  rounded-2xl  bg-white ">
 			<details className="group mx-4">
 				...
 				<p className="text-neutral-600 mt-3 text-left group-open:animate-fadeIn">{faqmap.answer}</p>
 			</details>
 		</div>
    ))}
