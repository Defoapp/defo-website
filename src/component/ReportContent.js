          ...
          <div className="w-full h-full">
            <form>
              ...
              {formStep === 0 && (<section>
                <div className="w-full h-full flex flex-col gap-y-1">
                  ...
                  <input
                    type="text"
                    name="username"
                    className="border-2 border-black rounded-md w-full h-9 my-1"
                  />
                  <label className="text-xl ">
                  ...
                  <input
                    type="text"
                    name="username"
                    className="border-2 border-black rounded-md w-full h-20 my-1"
                  />
                </div>
              </section>)}
              {/* second section */}
              {formStep === 1 &&(<section>
                <div className="w-full h-full flex flex-col gap-y-1">
                  ...
                  <select className="border-2 border-black rounded-md font-medium w-full h-9 my-1">
                    ...
                    <option className="font-medium">Title & description</option>
                  </select>
                  <label className="text-xl ">
                  ...
                  <input
                    type="text"
                    name="username"
                    className="border-2 border-black rounded-md w-full h-20 my-2"
                  />
                </div>
              </section>)}
              {formStep === 2 && (
                <section><div className="bg-green-500 w-fit p-4 rounded-xl mx-auto">
                  <h6 className=" text-white font-bold text-2xl">Submitted Successfully</h6>
                  </div>
                </section>
              )}
              ...
              <div className="flex my-5">
                {/* <button className="border-2 border-black text-xl font-medium w-20 h-9 rounded-xl">
                  Back
                </button> */}
                {renderButton()}
              </div>
