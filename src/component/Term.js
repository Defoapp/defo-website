...
const Term = () => {
  ...
  return (
      <div className="w-full h-full">
        ...
        <p className="text-xl leading-9 ">By downloading or using the app, these terms will automatically apply
        ...
        <p className="text-xl leading-9 ">LowPow is committed to ensuring that the app is as useful and
        ...
        <p className="text-xl leading-9 ">The Defo app stores and processes personal data that you have provided
        ...
        <p className="text-xl leading-9 ">The app does use third-party services that declare their Terms and
        ...
        <p className="text-xl leading-9 ">You should be aware that there are certain things that LowPow will not
          ...
          allowance left.</p>
        <p className="text-xl leading-9 ">If you’re using the app outside of an area with Wi-Fi, you should
        ...
        <p className="text-xl leading-9 "> Along the same lines, LowPow cannot always take responsibility for the
          ...
          the Service, LowPow cannot accept responsibility. With respect to
        ...
        <p className="text-xl leading-9 ">At some point, we may wish to update the app. The app is currently
        ...
        <p className="text-xl leading-9 ">We may update our Terms and Conditions from time to time. Thus, you
          ...
          this page.<br/> These terms and conditions are effective as of 2023-01-16</p>
        <h1 className="font-bold pt-2 text-3xl">Contact Us</h1>
        <p className="text-xl leading-9 ">If you have any questions or suggestions about our Terms and
