...
const Term = () => {
  ...
  return (
    <div className="w-full h-full">
      <Navbar />
      <div className=" m-auto pb-10 mt-20 w-11/12 h-full  ">
      <div className="w-full mb-7 flex items-center justify-center">
          <img src={term} alt="term" />
        </div>
        <h1 className="font-bold pt-2 text-3xl">Terms & Conditions</h1>
        <p className="text-xl leading-9 text-black text-left">By downloading or using the app, these terms will automatically apply
          ...
          related to it, still belong to LowPow.</p>
        <p className="text-xl leading-9 text-black text-left">LowPow is committed to ensuring that the app is as useful and
          ...
          without making it very clear to you exactly what you’re paying for.</p>
        <p className="text-xl leading-9 text-black text-left">The Defo app stores and processes personal data that you have provided
          ...
          security features and it could mean that the Defo app won’t work
          properly or at all.</p>
        <p className="text-xl leading-9 text-black text-left">The app does use third-party services that declare their Terms and
          Conditions.<br/>Link to Terms and Conditions of third-party service providers used by
          the app</p>
        ...
        <p className="text-xl leading-9 text-black text-left">You should be aware that there are certain things that LowPow will not
          ...
          or provided by your mobile network provider, but LowPow cannot take
          ...
          allowance left.</p>
        <p className="text-xl leading-9 text-black text-left">If you’re using the app outside of an area with Wi-Fi, you should
        ...
        <p className="text-xl leading-9 text-black text-left">Along the same lines, LowPow cannot always take responsibility for the
          ...
          the Service, LowPow cannot accept responsibility.</p>
        <p className="text-xl leading-9 text-black text-left"> With respect to
          LowPow’s responsibility for your use of the app, when you’re using the
          ...
          available to you. LowPow accepts no liability for any loss, direct or
          indirect, you experience as a result of relying wholly on this
          functionality of the app.</p>
        <p className="text-xl leading-9 text-black text-left">At some point, we may wish to update the app. The app is currently
          ...
          want to keep using the app. LowPow does not promise that it will
          ...
          must stop using the app, and (if needed) delete it from your device.</p>

        <h1 className="font-bold pt-2 text-3xl">Changes to This Terms and Conditions</h1>

        <p className="text-xl leading-9 text-black text-left">We may update our Terms and Conditions from time to time. Thus, you
          ...
          this page.</p>
        <p className="text-xl leading-9 text-black text-left">These terms and conditions are effective as of 2023-01-16</p>
        <h1 className="font-bold pt-2 text-3xl">Contact Us</h1>
        <p className="text-xl leading-9 text-black text-left">If you have any questions or suggestions about our Terms and
          Conditions, do not hesitate to contact us at support@yesdefo.com.</p>        
      </div>
      <Footer />
    </div>
  );
