      ...
      <div className='w-full h-full'>
        ...
        <div className="w-full flex flex-wrap my-10 py-10">
            ...
            <div className="w-full lg:w-1/2  text-2xl px-5 lg:px-32 ">
              ...
              <span className="font-bold">At Defo,</span> we are more than just a brand – we are a journey, a vision, and a passion that has evolved over time. Our story is a testament to our dedication, values, and commitment to making a difference in the world. Our mission is to make learning enjoyable and accessible, fostering a positive attitude towards education. 
              </h1>
        ...
        {/* desc setion */}
        <div className='w-full h-full text-center  bg-gradient-to-r from-defoGreen from-[-58.97%]  to-defoBlue to-50% py-16 px-8 md:px-28 lg:px-32'>
          <h1 className='text-white text-xl md:text-2xl lg:text-4xl font-semibold'>The Journey</h1>

          <p className='text-white text-xl md:text-xl lg:text-2xl'>Our journey has been a remarkable one, filled with ups and downs, challenges, and triumphs. Explore our key milestones and memorable moments that have shaped the world of entertainment. Along the way, we've learned valuable lessons, forged lasting partnerships, and built a community that shares our passion and values.</p>
        </div>

        <div>
          <h1 className='font-bold text-4xl text-white text-center my-16 py-5  bg-gradient-to-r from-defoGreen from-[-58.97%]  to-defoBlue to-50% ' >Time line</h1>
        </div>
      ...
      <div className=" flex">
        ...
        <ul className="w-fit mr-10 ">
          ...
          <div className="h-1/6 mb-10    ">
            <h1 className="text-xl md:text-2xl lg:text-4xl flex justify-end font-semibold ">2022</h1>
          </div>

          {/* <!--Second item--> */}
          <div className="h-1/6 mb-5 ">
            <h1 className="text-xl md:text-2xl lg:text-4xl flex justify-end font-semibold "> </h1>
          </div>

          {/* <!--Third item--> */}
          <div className="h-1/6 mb-36">
            <h1 className="text-xl md:text-2xl lg:text-4xl  flex justify-end font-semibold ">2023</h1>
          </div>
          ...
          <div className="h-96 mb-16 ">
            <h1 className="text-xl md:text-2xl lg:text-4xl  flex justify-end font-semibold ">2024</h1>
          </div>
        </ul>
        {/* ----------------- */}
        {/* right side of the time line */}
        {/* ----------------- */}
        <ul className="border-l-4 h-fit border-black ">
          {/* <!--First item--> */}
          <li className=" ">
            <div className="flex-start md:flex ">
              ...
              <div className="  lg:mb-2 ml-6 lg:ml-6  max-w-4xl  ">
                <p className="mb-6 text-xl md:text-2xl lg:text-2xl font-medium text-black">
                  The inception of <span className="font-bold">Defo</span>. A
                  small team with a big dream laid the foundation for what would
                  become a go-to destination for edutainment enthusiasts.
                </p>
                <div className="mb-4 ">
            ...
            <div className="flex-start md:flex ">
              ...
              <div className="mb-2 ml-6  max-w-4xl  ">
                <p className="mb-6 text-2xl font-medium text-black">
                  ...
                  <span className="font-bold">website</span>. A user-friendly
                  platform designed to deliver a seamless and immersive
            ...
            <div className="flex-start md:flex ">
              ...
              <div className="mb-2 ml-6  max-w-4xl  ">
                <p className="mb-6 text-2xl font-medium text-black">
                  ...
                  <span className="font-bold">Defo officially launched</span>{" "}
              ...
              <div className="mb-2 ml-6  max-w-4xl  ">
                ...
                <div className="my-20">
                  <img
                    src={fourthPicture}
                    alt="loading"
                    className=" mx-auto sm:w-5/6 lg:w-4/6"
                  />
                </div>
              </div>
            </div>
