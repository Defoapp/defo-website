    ...
    <nav className=" top-0 bg-black w-full flex py-3 justify-between items-center navbar">
      ...
      <ul className="list-none sm:flex  mr-10 hidden justify-end items-center flex-1">
        ...
        <a href="https://creator.yesdefo.com/">
          <li className="relative flex p-1.5 text-lg rounded-xl no-underline   items-center justify-center overflow-hidden bg-green-500 font-medium text-white shadow-2xl transition-all duration-300 before:absolute before:inset-0 before:border-0 before:border-white before:duration-100 before:ease-linear hover:bg-white hover:text-green-500 hover:shadow-green-500 hover:before:border-[25px]">
      ...
      <div className="sm:hidden mr-8  flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            !toggle ? "hidden" : "flex"
          } p-6 bg-black-gradient  bg-black absolute mt-56 right-0 mx-4 my-2 w-96 rounded-xl sidebar`}
        >
